...
<CardGrid>
  ...
  <Card title="AWS sans carte bancaire" icon="cloud-download">
    Toute la partie cloud se pratique sur un émulateur AWS gratuit, en local.
    [Comprendre →](/references/aws-local/)
  </Card>
</CardGrid>

:::tip[Tu n'as pas besoin de payer quoi que ce soit]
S3, EC2, RDS, SQS, Lambda, Terraform — tu pratiques **tout** sur un émulateur AWS
qui tourne sur ta machine. Pas de compte, pas de carte bancaire, pas de facture
surprise, et tu peux tout casser autant de fois que tu veux. Un vrai compte AWS
n'est nécessaire **qu'une seule fois**, pour le déploiement final du Module 5.
:::
